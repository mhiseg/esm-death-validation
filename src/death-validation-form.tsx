...
import { formatPatient, validatePatient } from "./components/patient-registration.ressources";
import { ConfirmationModal } from "./components/widget/confirmation-modal";
import { deathValidatedUuid, deathValidatedValue } from "./components/constants";
...
const DeathValidationForm = ({ patient, obs }) => {
    ...
    const [initialValues, setInitialValues] = useState({
        uuid: patient?.uuid,
        deathValidatedUuid: patient?.identifiers.find((identifier) => identifier.identifierType.uuid === deathValidatedUuid).uuid,
        confirmationCode: "",
    ...
    const validate = (values) => {
        validatePatient(abortController, values.uuid,values.deathValidatedUuid,{identifier: deathValidatedValue, identifierType: deathValidatedUuid }).then(results => {
            showToast({
